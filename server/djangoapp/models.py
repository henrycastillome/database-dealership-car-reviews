...
class CarDealer:
    ...
    def __init__(self, id, full_name, address, city, st, zip):
        self.id = id
...
class DealerReview:
    ...
    def __str__(self):
        return self.dealership, self.name, self.purchase, self.review, self.purchase_date, self.car_make, self.car_model, self.car_year, self.review_id
